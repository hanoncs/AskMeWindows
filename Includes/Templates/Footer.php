        ...
        <div class="row">
            <div class="col-md-4">
                <div class="widget widget_contact">
                    ...
                    <p>I am a single backend dev who just want's to make a place for people to educate each other and share your knowledge.</p>
                    <ul>
                        <li>
                            <span>Address :</span>
                        ...
                        <li>Email:
                            <a href="mailto:support@hanontest.com" target="_top">Support@hanontest.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-2">
